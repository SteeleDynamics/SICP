...
#|
 ...
 | stream version of estimate-integral will not have an argument telling how
 | many trials to perform. Instead, it will produce a stream of estimates
 | based on successively more trials.
 |#

; estimate-integral procedure (stream impl)
...
; estimate pi
(define pi (estimate-integral unit-circle? x1 x2 y1 y2))
(stream-ref pi 10)
(stream-ref pi 100)
(stream-ref pi 1000)
(stream-ref pi 10000)
