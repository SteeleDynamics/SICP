...
#|
 ...
 |                  └────────────┘
 |
 | Figure 3.37: Signal-flow diagram for the solution to a series RLC circuit.
 |
 |
 | Exercise 3.80
 |
 ...
 | by vC, the voltage across the capacitor, and iL, the current in the
 ...
 | of the circuit and the time increment dt. In a manner similar to that of
 | the RC procedure of exercise 3.73, RLC should produce a procedure that
 | takes the initial values of the state variables, vC0 and iL0, and produces
 | a pair (using cons) of the streams of states vC and iL. Using RLC, generate
 | the pair of streams that models the behavior of a series RLC circuit with
