...
#|
 ...
 | initial values y₀ and dy₀ for y and dy/dt and generates the stream of
 | successive values of y.
 |
 | Answer
 |
 | If we let a = 5, b = -6, y(0) = 5, and dy/dt(0) = 7, then
 |
 | y(t) = 8·(e^2t) - 3·(e^3t)
 |
 | y(1) = -1.14416197812
...
(stream-ref (solve-2nd 5 -6 0.000001 5 7) 1000000)
