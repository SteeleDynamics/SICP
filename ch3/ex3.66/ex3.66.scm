...
(stream-ref P (pairs-ref 1 1))
(stream-ref P (pairs-ref 1 2))
(stream-ref P (pairs-ref 1 3))
(stream-ref P (pairs-ref 1 4))

(stream-ref P (pairs-ref 2 2))
(stream-ref P (pairs-ref 2 3))
(stream-ref P (pairs-ref 2 4))
(stream-ref P (pairs-ref 2 5))

(stream-ref P (pairs-ref 3 3))
(stream-ref P (pairs-ref 3 4))
(stream-ref P (pairs-ref 3 5))
(stream-ref P (pairs-ref 3 6))

(stream-ref P (pairs-ref 4 4))
(stream-ref P (pairs-ref 4 5))
(stream-ref P (pairs-ref 4 6))
(stream-ref P (pairs-ref 4 7))

(stream-ref P (pairs-ref 5 5))
(stream-ref P (pairs-ref 5 6))
(stream-ref P (pairs-ref 5 7))
(stream-ref P (pairs-ref 5 8))

(stream-ref P (pairs-ref 6 6))
(stream-ref P (pairs-ref 6 7))
(stream-ref P (pairs-ref 6 8))
(stream-ref P (pairs-ref 6 9))
