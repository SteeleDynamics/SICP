...
#|
 ...
 | to solve general second-order differential equations d²y/dt² = f(dy/dt, y).
 |
 | Answer
 |
 |                                dy₀                  y₀
...
; pi/6
(define a (/ 3.141592654 6))

; dt
(define dt (/ a 100000))

; approximation of y(t) = cos(2·t)
(define y (solve-2nd f 1 0 dt))

; y(pi/6) = cos(2·pi/6) = cos(pi/3) = 0.5
(stream-ref y 100000)
