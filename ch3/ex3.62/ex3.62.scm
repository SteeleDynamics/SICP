...
#|
 ...
 | (If the denominator has a zero constant term, then div-series should signal
 | an error.) Show how to use div-series together with the result of exercise
