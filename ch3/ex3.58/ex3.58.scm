...
#|
 ...
 | Answer
 |
 | Given a rational number whose numerator (num) and denominator (den) are
 | integers of base radix, the evaluated stream (expand num den radix) expands
 | the rational number such that each digit is of base radix.
 |#
...
; rational number 1/7 (radix 10)
(stream-take (expand 1 7 10) 20)

; rational number 3/8 (radix 10)
(stream-take (expand 3 8 10) 20)

; rational number 4/3 (radix 16)
(stream-take (expand 4 3 16) 20)
