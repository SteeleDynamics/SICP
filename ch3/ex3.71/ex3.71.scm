...
#|
 ...
 | way are sometimes called Ramanujan numbers, in honor of the mathematician
 | Srinivasa Ramanujan. [70] Ordered streams of pairs provide an elegant
 | solution to the problem of computing these numbers. To find a number that
 | can be written as the sum of two cubes in two different ways, we need only
 | generate the stream of pairs of integers (i,j) weighted according to the
 | sum i³ + j³ (see exercise 3.70), then search the stream for two consecutive
 ...
 | §3.5.3 Footnote 70:
 |
 | To quote from G. H. Hardy's obituary of Ramanujan (Hardy 1921): "It was Mr.
 | Littlewood (I believe) who remarked that `every positive integer was one of
 | his friends.' I remember once going to see him when he was lying ill at
 ...
 | number expressible as the sum of two cubes in two different ways.'" The
 | trick of using weighted pairs to generate the Ramanujan numbers was shown
 | to us by Charles Leiserson.
 |#
