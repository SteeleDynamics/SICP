...
#|
 ...
 | frames) is included in this history, and how the check should be made. (After
 | you study the details of the query-system implementation in section 4.4.4,
 | you may want to modify the system to include your loop detector.)
 |
 | Answer:
 |
 | Strategy:
