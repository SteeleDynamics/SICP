...
(define exp1 '(fib 17))
(define exp2 '(define count 0))
(define exp3 '(define (id x) (set! count (+ count 1)) x))
(define exp4 '(define (square x) (* x x)))
(define exp5 '(square (id 10)))
(define exp6 'count)
...
(with-timings (lambda () (actual-value exp1 E0)) receiver)
(actual-value exp2 E0)
(actual-value exp3 E0)
(actual-value exp4 E0)
(actual-value exp5 E0)
(actual-value exp6 E0)
...
(with-timings (lambda () (actual-value exp1 E1)) receiver)
(actual-value exp2 E1)
(actual-value exp3 E1)
(actual-value exp4 E1)
(actual-value exp5 E1)
(actual-value exp6 E1)
