...
#|
 ...
 | §4.2.2 Footnote 38:
 |
 | This exercise demonstrates that the interaction between lazy evaluation and
...
(actual-value '(define count 0) E0)
(actual-value '(define (id x) (set! count (+ count 1)) x) E0)
(actual-value '(define w (id (id 10))) E0)
(actual-value 'count E0)
(actual-value 'w E0)
(actual-value 'count E0)
