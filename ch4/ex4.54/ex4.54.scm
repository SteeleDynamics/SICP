...
; require? predicate procedure
(define (require? exp) (tagged-list? exp 'require))

; require-predicate selector procedure
...
#|
 ...
 | ordinary procedure that uses 'amb', to be defined by the user as part of
 | a nondeterministic program, we would have had to implement it as a special
