...
#|
 ...
 |   ⟨body⟩)
 |
 | are a variation on 'let' in which the expressions <expₖ> that provide the
 | initial values for the variables <varₖ> are evaluated in an environment that
...
#|
 ...
 | ########################
 | (letrec ((⟨var₁⟩ ⟨exp₁⟩)                 (let ((⟨var₁⟩ '*unassigned*)
 |          ...                                   ...
 |          (⟨varₙ⟩ ⟨expₙ⟩))        <==>          (⟨varₙ⟩ '*unassigned*))
 |   ⟨body⟩)                                  (set! ⟨var₁⟩ ⟨exp₁⟩)
 |                                            ...
 |                                            (set! ⟨varₙ⟩ ⟨expₙ⟩)
 |                                            ⟨body⟩)
 ...
 |                       false                │ ┌─>│                     │ │ │
 |                       (even? (- n 1))))))  │ │  └─────────────────────┘ │ │
 |        ⟨rest of body of f⟩))               │ │    ⟨rest of body of f⟩   │ │
 |                                        ┌───┘ │                     ┌────┘ │
 |                                        V     │                     V      │
 |                                 ┌─────ꙨꙨ─────┘              ┌─────ꙨꙨ──────┘
 |                                 V                           V
 ...
 |                    (odd? (- n 1)))))    └───────────────────────┘ │ │ │ │ │ │
 |             (odd?                       ((lambda (even? odd?)     │ │ │ │ │ │
 |              (lambda (n)                   ⟨rest of body of f⟩)   │ │ │ │ │ │
 |                (if (= n 0)               (lambda (n)              │ │ │ │ │ │
 |                    false                   (if (= n 0)            │ │ │ │ │ │
 |                    (even? (- n 1))))))         true               │ │ │ │ │ │
 |        ⟨rest of body of f⟩))                   (odd? (- n 1))))   │ │ │ │ │ │
 |                                          (lambda (n)              │ │ │ │ │ │
 |                                            (if (= n 0)            │ │ │ │ │ │
 |                                                false              │ │ │ │ │ │
 |                                                (even? (- n 1))))) │ │ │ │ │ │
 ...
 |  body:                     body:                     body:
 |    ⟨rest of body of f⟩       (if (= n 0)               (if (= n 0)
 |                                  true                      false
 |                                  (odd? (- n 1)))           (even? (- n 1)))
 |
 |
