...
#|
 ...
 |
 | ==> The professor is lecturing the student. The lecturing occurs in the
 |     class. The lecturing occurs with the cat.
 |
 | Parse #2:
 |
 | (sentence
 ...
 |
 | ==> The professor is lecturing the student. The lecturing occurs in the
 |     class. The class itself has the cat.
 |
 | Parse #3:
 |
 | (sentence
 ...
 |       (simple-noun-phrase (article the) (noun cat)))))
 |
 | ==> The professor lectures the student. The student themselves is in the
 |     class. The lecturing occurs with the cat.
 |
 | Parse #4:
 |
 ...
 |
 | ==> The professor lectures the student. The student themselves is in the
 |     class. The student themselves has the cat.
 |
 | Parse #5:
 |
 | (sentence
