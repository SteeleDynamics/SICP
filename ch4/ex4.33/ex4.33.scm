...
#|
 ...
 | Answer
 |
 | 1. Non-pair literal expressions evaluate to themselves
 | 2. Pair literal expressions become derived expressions of nested 'cons'
 |    expressions. This derived expression is a tree whose leaves become
 |    non-pair quoted expressions.
 | 3. The derived expression is then lazily evaluated to obtain the correct
 |    literal lazy-list value.
 |#
...
(actual-value
  '(car (car (cdr (car (cdr (cdr '(d (b (a c)) (f (e g)))))))))
  E0)
