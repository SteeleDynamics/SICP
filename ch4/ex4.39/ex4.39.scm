...
#|
 ...
 | affect the answer? Does it affect the time to find an answer? If you think
 | it matters, demonstrate a faster program obtained from the given one by
 ...
 | complexity of O(n²).
 |
 | The following implementation was informally observed to be more efficient.
 |#
