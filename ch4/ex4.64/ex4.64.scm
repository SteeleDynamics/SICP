...
#|
 ...
 | Query                                    Unified Frame
 | #############################################################################
 | (outranked-by (Bitdiddle Ben) ?who)      ?staff-person-1 = (Bitdiddle Ben)
 |                                          ?boss-1 = ?who
 | (supervisor ?staff-person-1 ?boss-1)     ?staff-person-1 = (Bitdiddle Ben)
 | -> match successful                      ?boss-1 = ?who
 | (outranked-by ?middle-manager-1 ?boss-1) ?staff-person-1 = (Bitdiddle Ben)
 |                                          ?boss-1 = ?who
 |                                          ?staff-person-2 = ?middle-manager-1
 |                                          ?boss-2 = ?boss-1
 | (supervisor ?staff-person-2 ?boss-2)     ?staff-person-1 = (Bitdiddle Ben)
 | -> match failed                          ?boss-1 = ?who
 |                                          ?staff-person-2 = ?middle-manager-1
 |                                          ?boss-2 = ?boss-1
 | (outranked-by ?middle-manager-2 ?boss-2) ?staff-person-1 = (Bitdiddle Ben)
 |                                          ?boss-1 = ?who
 |                                          ?staff-person-2 = ?middle-manager-1
 |                                          ?boss-2 = ?boss-1
 |                                          ?staff-person-3 = ?middle-manager-2
 |                                          ?boss-3 = ?boss-2
