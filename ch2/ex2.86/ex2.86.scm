...
(define u ((get 'make 'rational) 1 2))
(define v ((get 'make 'real) 0.6))
(define w ((get 'make 'real) 0.5))
(define x ((get 'make 'rational) -3 5))
(define y ((get 'make 'complex) u v))
(define z ((get 'make 'complex) w x))
